...
/**
 * PlayerVolatility ist das Intervall zwischen dem der echte Skill des Spielers pro Spiel schwanken kann.
 * Das Intervall ist prozentual, d.h. 1 ist der echte Skill des Spielers und die Volatility beschreibt wie groß die Abweichung von 1 aus sein kann.
 * 
...
public class PlayerVolatility {
	 ...
	 * 
	 * @param range die prozentuale größtmögliche Abweichung des echten Skill des Spielers
	 */
