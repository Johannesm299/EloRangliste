 ...
 * zu Anfang wird der default Wert 1200 gegeben, welcher nach jedem Spiel
 * angepasst wird.
 * 
...
public class Playerrating {
	 ...
	 * 
	 * @param p
	 *            der Spieler dem dieses Objekt zugeordnet wird
	 */
	...
	/**
	 * spezieller Konstruktor fuer die Klasse Playerrating es kann eine beliebige
	 * Elozahl gegeben werden
	 * 
	 * @param n
	 *            die zugeteilte Elozahl
	 * @param p
	 *            der Spieler dem dieses Objekt zugeordnet wird
	 */
	 ...
	 * 
	 * @param SR1
	 *            Summe der Elozahlen von Team 1
	 * @param SR2
	 *            Summe der Elozahlen von Team 2
	 * @param team
	 *            Teamangehörigkeit des Spielers, dessen Rang angepasst wird
	 * @param winner
	 *            Gewinner des Spiels
	 * @param rT1
	 *            gewonnene Runden von Team 1
	 * @param rT2
	 *            gewonnene Runden von Team 2
	 * @param punkteS
	 *            Punktzahl(Score) des Spielers
	 * @param punkteT
	 *            Punktzahl(Score) des Teams
	 */
	public void adjustRanking(double SR1, double SR2, int team, int winner, int rT1, int rT2, int punkteS,
			int punkteT) {
		double lamda = 0.5;
		double i;
		double d;
