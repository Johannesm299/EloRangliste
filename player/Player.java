...
/**
 * Player ist die Klasse die Objekte unterschiedlicher Spieler erstellt.
 * Ein Teil der jeweiligen Spielerdaten werden lokal gespeicht, der Rest in anderen Klassen.
 * 
...
public class Player{
	 ...
	 * 
	 * @param skill der echte Skill den der Spieler bekommen soll
	 * @param range das Schwankungsintervall des Spielers
	 * @param n der Name des Spielers
	 * @param elo die Elozahl des Spielers
	 */
	 ...
	 * 
	 * Der Name des Spielers wird anhand seiner ID bestimmt, das Schankungsintervall ist ein Zufallswert
	 * innerhalb [0,0,5), der Rang des SPielers wird default-mäßig bestimmt und sein echter Skill ist
	 * Element einer pseudo-Normalverteilung mit einem Mittelwert von 49 und einer Standartabweichung von 13.
	 */
	public Player(){
		playerId=id++;
	...
	/**
	 * Setzt fest, dass der Player ein Match spielt.
	 * Setzt fest, dass der Player nicht mehr nach einem Match sucht.
	 */
	 ...
	 * @return der Name des Spielers, sowie sein echter Skill und sein Schwankungsintervall
	 */
